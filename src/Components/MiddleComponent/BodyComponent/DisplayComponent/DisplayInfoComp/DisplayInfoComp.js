...
import Styles from './DisplayInfoComp.module.css';
    ...
    return (
        <div className={Styles.displayInfoComp}>
            ...
            <p className={Styles.displayParagraph}>
                ...
                fnlgn lf fs gnlksfg lfijng s glkfns glfsng lfkm gkfsn jglis gls gsjgn fgsngjl.
            </p>
        </div>
    )
}

export default DisplayInfoComp;